            ...
            <div className='flex flex-col justify-between py-5 px-5 bg-[#1a1a1a] rounded-2xl h-[96vh]'>
                <div className='flex flex-col gap-12'>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='bg-[#303030e1] w-14 text-white h-14 flex text-xl justify-center items-center rounded-full cursor-pointer'>
                            <GrChat />
                        </div>
                        <div className='bg-[#303030e1] w-14 text-white h-14 flex text-2xl justify-center items-center rounded-full cursor-pointer'>
                            <IoCallOutline />
                        </div>
                        <div className='bg-[#303030e1] w-14 text-white h-14 flex text-2xl justify-center items-center rounded-full cursor-pointer'>
                            <MdGroups2 />
