...
const Chat = () => {
    ...
    return (
        <div className='bg-[#1a1a1a] w-[70rem] h-[96vh] text-white my-5 px-5 rounded-2xl flex flex-col justify-between me-5'>
            ...
            <div className="flex justify-between items-center gap-5 w-full bg-[#303030] py-3 px-5 rounded-2xl bottom-5 mb-5">
                <div className="flex justify-center items-center gap-5 w-full">
                    <GrAttachment className="cursor-pointer" />
                    <input className="w-full outline-none" type="text" placeholder="Write a message..." />
                </div>
                <IoPaperPlaneOutline className="cursor-pointer text-xl" />
            </div>
        </div>
    )
}
